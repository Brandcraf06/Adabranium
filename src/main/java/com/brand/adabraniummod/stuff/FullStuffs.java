...
import com.brand.adabraniummod.stuff.vanilla.netherite.MaterialNetheritePaxel;
...
public class FullStuffs { 
		...
		public static final MaterialNetheritePaxel materialNetheritePaxel = new MaterialNetheritePaxel();
