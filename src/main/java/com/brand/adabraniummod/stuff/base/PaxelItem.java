...
import com.brand.adabraniummod.mixin.AxeItemAccessor;
import com.brand.adabraniummod.mixin.ShovelItemAccessor;
...
public class PaxelItem extends MiningToolItem { 
	   ...
	   public float getMiningSpeed(ItemStack stack, BlockState state) {
	      ...
	      if (state.matches(BlockTags.WOOL)) {
	          return state.matches(BlockTags.WOOL) ? 10.0F : super.getMiningSpeed(stack, state);
	    	   ...
	    	   return THESE_MATERIALS.contains(material) ? this.miningSpeed : super.getMiningSpeed(stack, state);
	       }
	    }
	   ...
	   public ActionResult useOnBlock(ItemUsageContext context) {
		    ...
		    return ActionResult.SUCCESS;
		      ...
		      // axe		             
		    	    		     Blocks.LADDER, Blocks.SCAFFOLDING, Blocks.OAK_BUTTON, Blocks.SPRUCE_BUTTON, Blocks.BIRCH_BUTTON, Blocks.JUNGLE_BUTTON, Blocks.DARK_OAK_BUTTON, Blocks.ACACIA_BUTTON, 
		    		  });
		      
		      THESE_MATERIALS = Sets.newHashSet(new Material[]{
		    		             Material.METAL, Material.ANVIL, Material.STONE,                                   
		    		             Material.WOOD, Material.PLANT, Material.REPLACEABLE_PLANT, Material.BAMBOO, Material.PUMPKIN
		    		  });
