...
public class AdabraniumWorldgenProvider extends FabricDynamicRegistryProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registries, Entries entries) {
        entries.add(registries.getWrapperOrThrow(RegistryKeys.CONFIGURED_FEATURE), AdabraniumWorldgenFeatures.ORE_VIBRANIUM);
        entries.add(registries.getWrapperOrThrow(RegistryKeys.PLACED_FEATURE), AdabraniumWorldgenFeatures.PLACED_VIBRANIUM);
        entries.add(registries.getWrapperOrThrow(RegistryKeys.CONFIGURED_FEATURE), AdabraniumWorldgenFeatures.ORE_ADAMANTIUM);
        entries.add(registries.getWrapperOrThrow(RegistryKeys.PLACED_FEATURE), AdabraniumWorldgenFeatures.PLACED_ADAMANTIUM);
        entries.add(registries.getWrapperOrThrow(RegistryKeys.CONFIGURED_FEATURE), AdabraniumWorldgenFeatures.HEART_SHAPED_PLANT);
        entries.add(registries.getWrapperOrThrow(RegistryKeys.PLACED_FEATURE), AdabraniumWorldgenFeatures.PLACED_HEART_SHAPED_PLANT);
    }
