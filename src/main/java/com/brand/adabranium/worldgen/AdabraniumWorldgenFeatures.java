...
public class AdabraniumWorldgenFeatures {
    ...
    public static final RegistryKey<ConfiguredFeature<?, ?>> ORE_ADAMANTIUM = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Adabranium.id("ore_adamantium"));
    public static final RegistryKey<PlacedFeature> PLACED_ADAMANTIUM = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Adabranium.id("ore_adamantium"));
