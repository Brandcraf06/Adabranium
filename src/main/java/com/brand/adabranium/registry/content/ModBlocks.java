...
public class ModBlocks {
    ...
    public static final Block DEEPSLATE_VIBRANIUM_ORE = register("deepslate_vibranium_ore", settings -> new ExperienceDroppingBlock(UniformIntProvider.create(7, 14), settings), AbstractBlock.Settings.copy(VIBRANIUM_ORE).strength(9.0f, 6.0f).sounds(BlockSoundGroup.DEEPSLATE));
    ...
    public static final Block DEEPSLATE_ADAMANTIUM_ORE = register("deepslate_adamantium_ore", settings -> new ExperienceDroppingBlock(UniformIntProvider.create(7, 14), settings), AbstractBlock.Settings.copy(ADAMANTIUM_ORE).strength(21.0f, 9.0f).sounds(BlockSoundGroup.DEEPSLATE));
