...
public class ModBlocks {
    public static final Block VIBRANIUM_ORE = register("vibranium_ore", new ExperienceDroppingBlock(FabricBlockSettings.of(Material.STONE).strength(6.0f, 6.0f).requiresTool(), UniformIntProvider.create(7, 14)));
    public static final Block DEEPSLATE_VIBRANIUM_ORE = register("deepslate_vibranium_ore", new ExperienceDroppingBlock(FabricBlockSettings.copyOf(VIBRANIUM_ORE).strength(9.0f, 6.0f), UniformIntProvider.create(7, 14)));
    public static final Block ADAMANTINE_ORE = register("adamantine_ore", new ExperienceDroppingBlock(FabricBlockSettings.of(Material.STONE).strength(14.0f, 9.0f).requiresTool(), UniformIntProvider.create(7, 14)));
    public static final Block DEEPSLATE_ADAMANTINE_ORE = register("deepslate_adamantine_ore", new ExperienceDroppingBlock(FabricBlockSettings.copyOf(ADAMANTINE_ORE).strength(21.0f, 9.0f), UniformIntProvider.create(7, 14)));
