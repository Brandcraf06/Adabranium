...
public class ModBlocks {
    ...
    public static final Block ADAMANTIUM_ORE = register("adamantium_ore", new ExperienceDroppingBlock(FabricBlockSettings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).strength(14.0f, 9.0f).requiresTool(), UniformIntProvider.create(7, 14)));
    public static final Block DEEPSLATE_ADAMANTIUM_ORE = register("deepslate_adamantium_ore", new ExperienceDroppingBlock(FabricBlockSettings.copyOf(ADAMANTIUM_ORE).strength(21.0f, 9.0f).sounds(BlockSoundGroup.DEEPSLATE)));
