...
public class NetherStuff {
    ...
    public NetherStuff(String type) {
        ...
        this.axe = ModItems.register(type + "_axe", new BaseAxe(AdabraniumToolMaterials.NETHER_BRICK, 5.0F, -3.0F, (new Item.Settings().fireproof())));
        ...
        this.hoe = ModItems.register(type + "_hoe", new BaseHoe(AdabraniumToolMaterials.NETHER_BRICK, -2, -0.0F, (new Item.Settings().fireproof())));
